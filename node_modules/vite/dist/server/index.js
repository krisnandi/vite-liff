...
function createServer(config = {}) {
    const { root = process.cwd(), configureServer = [], resolvers = [], alias = {}, transforms = [], optimizeDeps = {} } = config;
    ...
    const resolvedPlugins = [
        ...
        ...(transforms.length ? [transform_1.createServerTransformPlugin(transforms)] : []),
