...
exports.serviceWorkerPlugin = ({ root, app, watcher, resolver, config }) => {
    ...
    let swScript = fs_1.default
        .readFileSync(path_1.default.resolve(__dirname, '../serviceWorker.js'), 'utf-8')
        ...
        .replace(/const __LOCKFILE_HASH__ =.*/, `const __LOCKFILE_HASH__ = ${JSON.stringify(depOptimizer_1.getDepHash(root, config.__path))}`)
