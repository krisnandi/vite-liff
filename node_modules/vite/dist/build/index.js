...
async function createBaseRollupPlugins(root, resolver, options) {
    ...
    return [
        ...
        // user transforms
        ...(transforms.length ? [transform_1.createBuildJsTransformPlugin(transforms)] : []),
...
async function build(options = {}) {
    ...
    const { root = process.cwd(), base = '/', outDir = path_1.default.resolve(root, 'dist'), assetsDir = '_assets', assetsInlineLimit = 4096, alias = {}, transforms = [], resolvers = [], rollupInputOptions = {}, rollupOutputOptions = {}, emitIndex = true, emitAssets = true, write = true, minify = true, silent = false, sourcemap = false, shouldPreload = null } = options;
    let spinner;
    ...
    const bundle = await rollup({
        ...
        plugins: [
            ...
            // vite:css
            buildPluginCss_1.createBuildCssPlugin(root, publicBasePath, assetsDir, minify, assetsInlineLimit, transforms),
            // vite:asset
