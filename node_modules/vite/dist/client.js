...
if ('serviceWorker' in navigator) {
    ...
    (async () => {
        ...
        if (__SW_ENABLED__) {
            ...
            // control.
            if (hasExistingSw) {
                navigator.serviceWorker.addEventListener('controllerchange', () => prompt(`[vite] Service worker cache invalidated. Reload is required.`));
            }
            else {
            ...
            prompt(`[vite] Unregistered stale service worker. ` +
